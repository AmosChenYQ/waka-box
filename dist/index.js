module.exports = (function(e, a) {
...
})(
  {
    ...
    104: function(e, a, p) {
      ...
      i.prototype.getStatusBar = function() {
        return this.axiosConfiguration
          .get(`users/current/status_bar/today`)
          .then(e => e.data);
      };
      const { GIST_ID: t, GH_TOKEN: n, WAKATIME_API_KEY: r } = process.env;
      const d = new i(r);
      const l = new o({ auth: `token ${n}` });
      async function main() {
        const e = await d.getStatusBar();
        await updateGist(e);
      }
